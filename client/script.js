...
function updateDescription (item, text) {
    if (item == 'board-description' && text != '') {
        $('#board-description').text(text);
    }
}
...
function drawNewCard(id, text, x, y, rot, colour, type, sticker, animationspeed,createdby) {
    ...
    if (type == 'card' || type == null) {
        h = '<div id="' + id + '" class="card ' + colour +
            ...
            'deg);\
        " data-toggle="tooltip" title="' + createdby + '">\
...
// cards
//----------------------------------
function createCard(id, text, x, y, rot, colour, type,createdby) {

    //console.log('Hello Card');

    drawNewCard(id, text, x, y, rot, colour, type, null, null,createdby);
...
$(function() {
    ...
    $("#create-card")
        .click(function() {
    var user_name = getCookie('scrumscrum-username');
//console.log('I am click',user_name);
    ...
    $(".descriptionCeditable").editable({
        ...
        save: function(content) {
            ...
            var action = "editDescriptionText";
